...
//   First->GetYaxis()->SetTitleOffset(0.8);
  ...
  Double_t *dum = 0;
   ...
   NLO_exp->SetLineColor(kBlue+3);
   NLO_exp->SetLineStyle(4);
...
//    grshade->SetPoint(24,197.7,167.5);
  ...
  //first one
   ...
   grshade2->SetFillColor(kCyan);
   //   grshade2->SetFillStyle(3001);
   grshade2->SetLineColor(kBlue+3);
   grshade2->SetLineStyle(4);
...
+      cout << " here " << endl;
  ...
  if(tanBeta_ == 3){
    TEV_sn_d0_1->SetFillColor(kGreen+3);
    TEV_sn_d0_1->SetFillStyle(3001);
    TEV_sn_d0_1->Draw("fsame");
    TEV_sn_d0_2->SetFillColor(kGreen+3);
    TEV_sn_d0_2->SetFillStyle(3001);
    TEV_sn_d0_2->Draw("fsame");
  }

  
  LEP_ch->SetLineColor(3);
  LEP_ch->SetFillColor(3);  
  LEP_ch->SetFillStyle(3001);  
  LEP_ch->Draw("fsame");
  ...
  TEV_sg_cdf->SetLineColor(2);
  TEV_sg_cdf->SetLineWidth(0);  
  TEV_sg_cdf->SetLineStyle(1);  
  TEV_sg_cdf->SetFillColor(2);  
  TEV_sg_cdf->SetFillStyle(3001);  
  TEV_sg_cdf->Draw("fsame");
  TEV_sg_d0->SetLineColor(kMagenta+1);
  TEV_sg_d0->SetFillColor(kMagenta+1);
  TEV_sg_d0->SetLineWidth(2);  
  TEV_sg_d0->SetFillStyle(3335);  
  TEV_sg_d0->Draw("same");  
