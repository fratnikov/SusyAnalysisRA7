...
%%% CAPTION FOR PLOT: ZDIJET_metDistribution.pdf
% Results of the $\rm{Z}+\rm{dijet}$ analysis. The observed \MET\ distribution (black points) is compared with the sum of the predicted \MET\
