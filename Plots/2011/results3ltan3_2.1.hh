...
// Graph observed
  ...
  double yy[11] = {185.882, 215.039, 210.842, 232.092, 243.312, 247.23, 293.218, 303.407, 312.182, 297.408, 300.042};
...
// Graph expected
  ...
  double yy[11] = {260, 267.33, 260.329, 251.985, 267.298, 270.7, 306.279, 316.554, 324.245, 322.988, 320.111};
  TGraph* graph = new TGraph(11, xx, yy);
// end expected
   graph->SetLineWidth(3);
   graph->SetMarkerStyle(8);
...
// Graph expectedM1
  double xx[11] = {300, 275, 250, 225, 200, 175, 150, 125, 100, 75, 50};
  double yy[11] = {182.438, 213.787, 214.181, 238.284, 253.815, 258.243, 296.778, 304.56, 313.075, 302.003, 307.144};
  TGraph* graph = new TGraph(11, xx, yy);
// end expectedM1
   graph->SetLineWidth(3);
   graph->SetMarkerStyle(8);
